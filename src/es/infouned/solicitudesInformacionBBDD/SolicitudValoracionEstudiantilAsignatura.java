	...
	public String generarCadenaRespuesta(String saltoDeLinea){
		...
		try {
			if (resultSet.next() == false) {
				cadenaRespuesta = "No hay información sobre las valoraciones estudiantiles de la asignatura " + asignatura.getNombre() + " en la base de datos.";
			} else {
				do {
				...
				cadenaRespuesta = "Las calificaciones que ha obtenido la asignatura " + asignatura.getNombre() + " de la titulación " + titulacion.getNombre() + " en los últimos años según los cuestionarios"
