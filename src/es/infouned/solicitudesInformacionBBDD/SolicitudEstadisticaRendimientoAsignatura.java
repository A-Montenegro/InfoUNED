	...
	public String generarCadenaRespuesta(String saltoDeLinea){
		...
		try {
			if (resultSet.next() == false) {
				cadenaRespuesta = "No se han encontrado estadísticas de " + nombreParametroEstadistico + " para la asignatura " + asignatura.getNombreAsignatura()
						  + " de la titulación " + titulacion.getNombreTitulacion() + " en la base de datos.";
		    } else {
		        do {
				...
				cadenaRespuesta = "Las estadísticas de " + nombreParametroEstadistico + " para la asignatura " + asignatura.getNombreAsignatura()
						  + " de la titulación " + titulacion.getNombreTitulacion()  + " en los últimos años son las siguientes:" + saltoDeLinea + cadenaRespuesta;
		    }
