	...
	public String generarCadenaRespuesta(String saltoDeLinea){
		...
		try {
			if (resultSet.next() == false) {
				...
				cadenaRespuesta = "El número de matriculados en la asignatura " + asignatura.getNombreAsignatura() + " de la titulación "
						 + titulacion.getNombreTitulacion() + " en los últimos años son los siguientes:" + saltoDeLinea + cadenaRespuesta;
			}
